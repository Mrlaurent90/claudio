...
export const travelData: TravelData = {
      ...
      moments: [
        ...
        },
        {
          ...
          steps: [
            ...
            { t: "14:00", cat: "payant", title: "San Clemente", desc: "Basilique à 3 niveaux : église baroque, basilique paléochrétienne, puis temple de Mithra souterrain. Refuge au frais les après-midis de chaleur.", logi: "Réservation conseillée · ouvert le lundi.", badges: [["bdg-opt", "Optionnel"]] },
            { t: "15:00", cat: "payant", title: "Palazzo Spada", desc: "La fausse perspective de Borromini (trompe-l'œil).", logi: "Ouvre 8h30–19h30, fermé le mardi.", badges: [["bdg-opt", "Optionnel"]] },
      ...
      moments: [
        ...
        },
        {
          ...
          steps: [
            ...
            { t: "18:00", cat: "exterieur", title: "Pyramide de Cestius", desc: "Pyramide antique (12 av. J.-C.) encastrée dans les remparts d'Aurélien. Vue extérieure uniquement — intérieur fermé à ces dates. Gratuit." },
            { t: "18:15", cat: "chill", title: "Cimetière protestant", desc: "Cimitero Acattolico : tombes de Keats & Shelley, cyprès et colonie de chats. Havre de paix au pied de la Pyramide. Gratuit.", logi: "Juste à côté de la Pyramide." },
          ],
        },
        {
          label: "Soirée",
          hr: "19h+",
          steps: [
            { t: "19:15", cat: "fontaine", title: "Fontana dell'Acqua Paola", desc: "« Il Fontanone » : fontaine monumentale baroque + panorama (scène d'ouverture de La Grande Bellezza).", logi: "Sur la montée vers le Gianicolo." },
  ...
  places: [
    ...
    { n: "Fontaine des 4 Fleuves", cat: "fontaine", day: 0, t: "16:30", lat: 41.8992, lng: 12.4731, info: "Piazza Navona · Bernin" },
    { n: "Pasquino (statue parlante)", cat: "statue", day: 0, t: "16:45", lat: 41.8985, lng: 12.4719, info: "La 1re statue parlante" },
    { n: "Campo de' Fiori", cat: "exterieur", day: 0, t: "17:15", lat: 41.8956, lng: 12.4722, info: "Place vivante" },
    { n: "Panthéon", cat: "exterieur", day: 0, t: "18:00", lat: 41.8986, lng: 12.4769, info: "Temple antique · oculus" },
    { n: "Fontaine du Panthéon", cat: "fontaine", day: 0, t: "18:30", lat: 41.8990, lng: 12.4768, info: "Fontana del Pantheon · obélisque" },
    { n: "Fontaine de Trevi", cat: "fontaine", day: 0, t: "19:30", lat: 41.9009, lng: 12.4833, info: "Le soir, jeter la pièce" },
    { n: "Piazza di Spagna + Barcaccia", cat: "fontaine", day: 0, t: "20:00", lat: 41.9058, lng: 12.4823, info: "Escaliers + fontaine Bernin" },
    { n: "Castel Sant'Angelo", cat: "payant", day: 1, t: "09:00", lat: 41.9031, lng: 12.4663, info: "Réservé 9h · terrasse pano" },
    { n: "Ponte Sant'Angelo", cat: "pano", day: 1, t: "10:45", lat: 41.9016, lng: 12.4664, info: "Anges du Bernin" },
    { n: "San Clemente", cat: "payant", day: 1, t: "14:00", lat: 41.8894, lng: 12.4975, info: "Basilique 3 niveaux · refuge au frais · résa conseillée" },
    { n: "Palazzo Spada", cat: "payant", day: 1, t: "15:00", lat: 41.8954, lng: 12.4715, info: "Optionnel · trompe-l'œil · 8h30–19h30, fermé mardi" },
    { n: "Fontaine des Tortues", cat: "fontaine", day: 1, t: "15:45", lat: 41.8941, lng: 12.4775, info: "Ghetto juif · la plus mignonne" },
    { n: "Marforio (statue parlante)", cat: "statue", day: 1, t: "16:30", lat: 41.8936, lng: 12.4843, info: "Musées Capitolins" },
    ...
    { n: "Il Babuino (statue)", cat: "statue", day: 1, t: "17:30", lat: 41.9070, lng: 12.4790, info: "Via del Babuino" },
    { n: "Speakeasy (soir)", cat: "bar", day: 1, t: "21:00", lat: 41.8990, lng: 12.4710, info: "Jerry Thomas Project · à arbitrer" },
    { n: "Coupole St-Pierre", cat: "pano", day: 2, t: "08:00", lat: 41.9022, lng: 12.4539, info: "8h · réservé" },
    { n: "Basilique St-Pierre", cat: "payant", day: 2, t: "09:30", lat: 41.9022, lng: 12.4533, info: "Tenue correcte" },
    { n: "Borgo Pio (déjeuner)", cat: "food", day: 2, t: "12:30", lat: 41.9047, lng: 12.4585, info: "Ruelle piétonne" },
    { n: "Musées du Vatican", cat: "payant", day: 2, t: "15:00", lat: 41.9065, lng: 12.4536, info: "15h · réservé" },
    { n: "Ice Club Roma (bar de glace)", cat: "bar", day: 2, t: "21:00", lat: 41.9006, lng: 12.4717, info: "Bar de glace · optionnel" },
    { n: "Galleria Borghese", cat: "payant", day: 3, t: "09:00", lat: 41.9142, lng: 12.4922, info: "9h · à réserver" },
    { n: "Villa Borghese (Pincio)", cat: "pano", day: 3, t: "11:15", lat: 41.9109, lng: 12.4783, info: "Parc + terrasse" },
    { n: "Piazza del Popolo", cat: "pano", day: 3, t: "12:30", lat: 41.9108, lng: 12.4768, info: "Vue depuis Pincio" },
    { n: "Via del Babuino (déjeuner)", cat: "food", day: 3, t: "13:15", lat: 41.9070, lng: 12.4793, info: "Vers place d'Espagne" },
    { n: "Aventin — Trou de serrure", cat: "statue", day: 3, t: "16:30", lat: 41.8836, lng: 12.4783, info: "Buco di Roma" },
    { n: "Jardin des Orangers", cat: "pano", day: 3, t: "17:15", lat: 41.8843, lng: 12.4794, info: "Vue · à côté" },
    { n: "Pyramide de Cestius", cat: "exterieur", day: 3, t: "18:00", lat: 41.8758, lng: 12.4814, info: "Vue extérieure · intérieur fermé · gratuit" },
    { n: "Cimetière protestant", cat: "chill", day: 3, t: "18:15", lat: 41.8764, lng: 12.4787, info: "Keats & Shelley · chats · gratuit" },
    { n: "Fontana dell'Acqua Paola", cat: "fontaine", day: 3, t: "19:15", lat: 41.8895, lng: 12.4626, info: "« Il Fontanone » · panorama Gianicolo" },
    { n: "Gianicolo (belvédère)", cat: "pano", day: 3, t: "19:30", lat: 41.8919, lng: 12.4614, info: "Sunset" },
